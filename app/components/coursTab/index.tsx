...
//                         <h3 className="text-midnightblue text-4xl lg:text-55xl font-semibold mb-5 sm:mb-0">Cours Populaires</h3>
//                         <Link href={'/'} className="text-Blueviolet text-lg font-medium space-links">Voir plus&nbsp;&gt;&nbsp;</Link>
//                     </div>
